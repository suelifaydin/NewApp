...
import CustomButton from '../../../../components/Buttons/primarybutton';
  ...
  return (
    ...
    >
      ...
      <TouchableOpacity style={styles.backButtonContainer} onPress={() => navigation.goBack()}>
        <Image source={require('../../../../assets/icons/global-icon/vector.png')} style={styles.backIcon} />
      </TouchableOpacity>
      ...
      <TouchableOpacity style={styles.facebookButton}>
        <Image
          source={require('../../../../assets/icons/auth-screen/facebook.png')}
          resizeMode='contain'
          style={styles.icon2}
        />
      ...
      <TouchableOpacity style={styles.googleButton}>
        <Image source={require('../../../../assets/icons/auth-screen/google.png')} style={styles.icon} />
