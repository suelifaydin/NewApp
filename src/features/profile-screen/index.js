...
const ProfileScreen = observer(({ navigation }) => {
  const styles = useAppStyles(profileStyles); 
  ...
  const getCurrentLanguage = () => {
    switch (i18n.language) {
      case 'tr':
        return { label: 'Türkçe', flag: require('../../assets/images/flag/flag-tr.png') };
      case 'de':
        return { label: 'Deutsch', flag: require('../../assets/images/flag/flag-de.png') };
      case 'ru':
        return { label: 'Русский', flag: require('../../assets/images/flag/flag-ru.png') };
      case 'en':
      default:
        return { label: 'English', flag: require('../../assets/images/flag/flag-en.png') };
    }
  };
